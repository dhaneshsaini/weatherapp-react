...
export default function DayCard({ data }) {
    ...
    return (
        <div className="bg-gradient-to-tr from-white/5 to-white/20 rounded-lg py-3 flex items-center">
            <div className="px-5">
                <WeatherIcon fontSize={56} iconname={data.weather[0].main} />
            </div>
            <div className="flex-1 px-5">
                <div className="mb-2">
                    <span className="block text-sm font-semibold">{getDayName(date.getDay())}</span>
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        <span className="text-xl font-medium">{Math.floor(data.temp.max)}°</span>
